...
import com.shenmajr.boot.domain.specification.Criterion.Operator;
import com.shenmajr.boot.domain.specification.imp.LogicalExpression;
import com.shenmajr.boot.domain.specification.imp.SimpleExpression;

/**
 * ClassName: Restrictions
 * Description: 条件构造器 运算符重载
 * Author: fujianjian
 * Date: 2016年1月28日
 */
